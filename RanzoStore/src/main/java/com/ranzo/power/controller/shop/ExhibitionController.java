...
public class ExhibitionController {
	...
	public ModelAndView getList(@RequestParam(defaultValue = "리뷰 많은순") String sort,
			@RequestParam(defaultValue = "전체") List<String> location, ModelAndView mav) {
	...
	public ModelAndView searchDatelist(@RequestParam(defaultValue = "") String searchDate, ModelAndView mav)
			throws Exception {
