...
public class ExhibitionDTO {
	...
	public ExhibitionDTO(String code, String location, String gallery, String title, String summary, String thumnail,
			...
			String keyword, String searchDate, int adult_price, int teen_price, int kids_price) {
		super();
		this.code = code;
		this.location = location;
		this.gallery = gallery;
	...
	public String toString() {
		return "ExhibitionDTO [code=" + code + ", location=" + location + ", gallery=" + gallery + ", title=" + title
				...
				+ start_date + ", end_date=" + end_date + ", hit=" + hit + ", sales=" + sales + ", rn=" + rn + ", show="
				+ show + ", keyword=" + keyword + ", searchDate=" + searchDate + ", adult_price=" + adult_price
				+ ", teen_price=" + teen_price + ", kids_price=" + kids_price + "]";
	}
