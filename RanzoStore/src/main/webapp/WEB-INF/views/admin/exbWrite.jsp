...
<body>
	...
	<table class="adminTable3">
			...
			<tr>
			<th>전시관</th>
			<td><input name="gallery" id="gallery" placeholder=""></td>
			</tr>
			<tr>
			<th>전시지역</th>
			<td><input name="location" id="location" placeholder=""></td>
			</tr>
			<tr>
			<th>전시 시작일</th>
			...
			<tr>
			<th>전시 가격</th>
			<td><input type="number" name="adult_price" id="adult_price" placeholder="성인">
			...
			<tr>
			<th>포스터 이미지(10MB)</th>
			<td><input type="file" name="file1" id="file1" onchange="fileSize(this, 'filesize1')">
			...
			<tr>
			<th>포스터 URL</th>
			<td><input type="text" name="thumnail" id="thumnail">
				<div><img id="urlImage1" style="width: 50%; height: 50%"></div>
			</td>
			</tr>
			<tr>
			<th>전시 정보 이미지(10MB)</th>
			<td><input type="file" name="file2"	id="file2" onchange="fileSize(this, 'filesize2')">
			...
			<tr>
			<th>전시 정보 URL</th>
			<td><input type="text" name="attach" id="attach">
