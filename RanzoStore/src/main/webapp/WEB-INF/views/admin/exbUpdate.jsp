...
$(function() { 
	...
	function fileSize(target, name) {
		...
		if (file.size > maxsize) {
			...
			if(name=='filesize1') $("#file").val('');
			if(name=='filesize2') $("#file2").val('');
		} else {
			if (file.size >= 1024) filesize = Math.round(file.size / 1024);
		...
		<form name="form1" enctype="multipart/form-data" method="post">
			<table class="adminTable3">
				<tr>
					...
					<td><input name="code" id="code" value="${dto.code}" 
					readonly style="background-color:#e4e4e4;"></td>
				</tr>
				<tr>
					<th>전시명</th>
				...
				<tr>
					<th>전시관</th>
					<td><input name="gallery" id="gallery" value="${dto.gallery}"></td>
				</tr>
				<tr>
					<th>전시지역</th>
					<td><input name="location" id="location" value="${dto.location}"></td>
				</tr>
				<tr>
					<th>전시 시작일</th>
					<td><input type="date" name="start_date" id="start_date" 
					value="${fn:substring(startDate,0,10)}"></td>
					</tr>
				<tr>
					<th>전시 마감일</th>
				...
				<tr>
					<th>전시 가격</th>
					<td><input type="number" name="adult_price" id="adult_price" placeholder="성인" value="${dto.adult_price}">
						<input type="number" name="teen_price" id="teen_price" placeholder="청소년" value="${dto.teen_price}">
				...
				<tr>
					...
					<td>
						...
						<div><img id="urlImage2" style="width: 50%; height: 50%"></div>
					</td>
				</tr>
			</table>
			...
			<table class="adminTable3">
				...
				<td><input name="summary" id="summary" value="${dto.summary}"></td>
				</tr>
				<tr>
				<th style="width:15%;">전시 정보</th>
				<td><textarea name="content" id="content" placeholder="내용을 입력해주세요." 
				rows="20">${idto.content}</textarea>
				</td>
				</tr> 
			</table>
		</form>
