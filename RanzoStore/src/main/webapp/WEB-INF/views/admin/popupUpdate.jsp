...
<body>
	...
	<%@ include file="../include/adminDashboard.jspf"%>
		...
		<table class="adminTable3">
			...
			<tr>
			<th>시작일</th>
			<td><input type="date" name="start_date" id="start_date" value="${fn:substring(startDate,0,10)}"> 
				<input type="time" name="start_time" id="start_time" value="${fn:substring(dto.start_date,11,19)}"></td>
			</tr>
			<tr>
			<th>마감일</th>
			<td><input type="date" name="end_date" id="end_date" value="${fn:substring(endDate,0,10)}"> 
				<input type="time" name="end_time" id="end_time" value="${fn:substring(dto.end_date,11,19)}"></td>
			</tr>
			<tr>
			<tr>
			<th>상단 위치</th>
			<td><input type="number" name="pos_height" id="pos_height" value="${dto.pos_height}"></td>					</tr>
			<tr>
			<th>좌측 위치</th>
			<td><input type="number" name="pos_width" id="pos_width" value="${dto.pos_width}"></td>
			</tr>
			<tr>
			<th>가로 사이즈</th>
			<td><input type="number" name="img_width" id="img_width" value="${dto.img_width}"></td>
			</tr>
			<tr>
			<th>세로 사이즈</th>
			<td><input type="number" name="img_height" id="img_height" value="${dto.img_height}"></td>
			</tr>
			<tr>
			<th>이미지 URL</th>
			<td><c:choose>
				...
				<div><img id="urlImage" style="width: 50%; height: 50%"></div>
			</td>
			</tr>
			<tr>
			<th>이미지 등록(10MB 이하)</th>
			<td><input type="file" name="file" id="file" onchange="fileSize(this)">
