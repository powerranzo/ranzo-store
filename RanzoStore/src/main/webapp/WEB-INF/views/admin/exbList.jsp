				...
				<table class="adminTable2">
					<tr>
						...
						<td colspan="2" id="adminTB2_td1">
							...
							<input type="text" name="searchKeyword" value="${exb.searchOp.searchKeyword}">
							</div>
						</td>
					</tr>
					<tr>
				...
				<tbody>
					<tr>
						...
						<td><c:choose>
							...
							<button class="btn btn-sm" type="button" id="" onclick="exbView('${dto.code}')">
							<span class="glyphicon glyphicon-check"></span>&nbsp;수정
							</button>
							<button class="btn btn-sm" type="button" id="" onclick="exbDel('${dto.code}')">
							<span class="glyphicon glyphicon-minus-sign"></span>&nbsp;종료
							</button>
							</c:when>
							<c:otherwise>
							<button class="btn btn-sm" type="button" id="" onclick="exbShow('${dto.code}')">
