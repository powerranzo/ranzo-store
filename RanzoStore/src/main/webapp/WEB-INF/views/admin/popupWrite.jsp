...
<body>
	...
	<%@ include file="../include/adminDashboard.jspf"%>
		...
		<table class="adminTable3">
			...
			<tr>
			<th>상단 위치</th>
			<td><input type="number" name="pos_height" id="pos_height" value="100"></td>
			</tr>
			<tr>
			<th>좌측 위치</th>
			<td><input type="number" name="pos_width" id="pos_width" value="100"></td>
			</tr>
			<tr>
			<th>가로 사이즈</th>
			<td><input type="number" name="img_width" id="img_width" value="400">
			</td>
			</tr>
			<tr>
			<th>세로 사이즈</th>
			<td><input type="number" name="img_height" id="img_height" value="500"></td>
			</tr>
			<tr>
			<th>이미지 URL</th>
